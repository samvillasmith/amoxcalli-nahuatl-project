...
| D19-QA-007 | Public-release readiness | BLOCKER | 12 review-only lines; speaker/community status file recorded: yes; completed validation: no. | Complete editorial and speaker/community review, then promote or rewrite each review-only line. |
